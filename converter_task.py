...
# 定义路径
BASE_INPUT_PATH = '/wuxiangbo/china_medical_case_repository/data-sort/'
BASE_OUTPUT_PATH = '/wuxiangbo/md_output/'
...
if __name__ == '__main__':
    ...
    # parser = argparse.ArgumentParser(description='send sub dir name')
    # parser.add_argument('sub_dir',type=str,help='sub dir of input pdf datas')
    # args = parser.parse_args()

    # sub_dir_name = args.sub_dir  
    # sub_dir_names = ['1000-1999','2000-2999','3000-3999']
    sub_dir_names_1 = ['30000-30999']
